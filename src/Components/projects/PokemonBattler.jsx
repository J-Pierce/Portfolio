    ...
    <section className="project">
      ...
      <section className="body">
        <p>
          ...
          pokemon to battle against an opponent. Within a battle they can choose
          what move to play and swap out pokemon.Once all of either your or your
          opponent's pokemon have fainted the match is over.
        </p>
