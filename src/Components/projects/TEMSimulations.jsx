      ...
      <main>
        ...
        <section className="body">
          <p>
            ...
            been a driving factor that has lead to their application in a
            diverse range of fields. However, their stability need to be
            improved if they are to be synthesisable on an industrial scale.
            This can be achieved though an improved understanding of their
            structure, provided by transmission electron microscopy.
            Computational modelling offers many insights into the processes that
            take place during imaging, and can help us better understand how to
            decrease beam damage and improve image interpretation.
          </p>
          ...
          <p>
            ...
            importance, and it is theorised that other factors such as
            electronic conductivity are likely to play a role in resilience.
          </p>
        </section>
      </main>
    </section>
