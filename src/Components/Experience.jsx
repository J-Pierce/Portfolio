    ...
    <section className="experience">
      <section className="jobs">
        ...
        <section className="job">
          <p id="date">January 2025 - April 2025</p>
          <section>
            <h3 className="title">
              Junior Software Developer, Northcoders Bootcamp
            </h3>
            <ul>
              <li id="task">
                Day to day pair programming using JavaScript to build projects
                using testing driven development
              </li>

              <li id="task">
                Alongside JavaScript, SQL used to build a backend server.
                Experienced using seeding and migrations
              </li>
              <li id="task">
        ...
        <section className="job">
          <p id="date">September 2023 - September 2024</p>
          <section>
            <h3 className="title" id="status">
              PhD Electrical Engineering, University of Glasgow
            </h3>
            <p className="status">Incomplete</p>
            <ul>
              <li id="task">
                Conducted simulations of distributed-feedback lasers using
                Lumerical modelling software. Used results to guide fabrication
                in the James Watt Nanofabrication Centre.
              </li>
              <li id="task">
                Enhanced cleanroom skills and gained experience working on an
                array of fabrication lab equipment
              </li>
            </ul>
          </section>
        </section>
